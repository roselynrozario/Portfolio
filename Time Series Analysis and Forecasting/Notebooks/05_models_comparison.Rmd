...
load("../data/processed/model_5_forecast_values.RData")
```
...
autoplot(ts_test_data, series = "Historical (Test)") +
    autolayer(model_5_forecast_values$mean, series = "NNAR") +
    autolayer(model_4_forecast_values$mean, series = "ARFIMA") +
    autolayer(model_3_forecast_values$mean, series = "ETS") +
